(function() {
	...
	SidenavCtrl.$inject = ['$log', '$mdSidenav', '$state', '$mdBottomSheet',
		'$mdToast', 'MenuService', '$scope', 'LoginService', '$rootScope'
	];
	...
	function SidenavCtrl($log, $mdSidenav, $state, $mdBottomSheet, $mdToast,
		MenuService, $scope, LoginService, $rootScope) {
		...
		// Only use $scope in controllerAs when necessary; for example,
		// publishing and subscribing events using $emit, $broadcast, $on or $watch.
